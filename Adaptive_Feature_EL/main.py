...
parser.add_argument("--learning_rate", type=float,
                    help="learning rate",
                    default=2e-4)  # 2e-4 afterwards 5e-5
...
random.seed(args.seed)  # set random seed for cpu
...
F1_CSV_Path = args.output_path + args.method + "_" + args.order + "_" + str(args.tok_top_n) + "-" \
              ...
              + timestr + "_" + str(args.order_learning) + "_" + args.sort + "_" + str(args.seq_len) + str(
    args.isDynamic) + str(args.dca_method) + str(args.one_entity_once) + "f1.csv"
...
if __name__ == "__main__":
    ...
    config = {'hid_dims': args.hid_dims,  # 100
              ...
              # 7 number of top previous disambiguated mentions for the whole model
    ...
    if args.mode == 'train':
        ...
        config = {'lr': args.learning_rate, 'n_epochs': args.n_epochs, 'isDynamic': args.isDynamic,
